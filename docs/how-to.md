...
3. Include the backend in some controller:
...
5. Render the pagination:
    ...
    - If your app renders the views server-side:
        ...
        1. Include the frontend in some helper:
    ...
    - If your app renders the views with a javascript framework (e.g. Vue.js, react.js, ...)
    ...
    - If your app is an API service consumed by some client and doesn't provide any UI on its own:
